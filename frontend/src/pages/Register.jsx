...
export default function Register() {
  ...
  return <section className="auth-shell register-shell">
    ...
    <div className="auth-panel"><div className="auth-panel-inner register-panel"><span className="mobile-logo">SR</span>
      {step === 'details' ? <><p className="eyebrow">Student registration</p><h2>Create your account</h2><p>Register instantly with Google or verify your email manually.</p>{error && <div className="message error">{error}</div>}<GoogleSignIn onError={setError} />
